  ...
  <div id="app">
                    ...
                    <ul class="nav navbar-nav navbar-right" style="margin-top:0px;margin-bottom:0px">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li style="width: 63px;"><a href="https://mmzm.moe/resources/android.apk" download="android.apk" target="_blank" style="padding-left: 18px;padding-top: 0px;padding-bottom: 11px;"><img src="resources/Android.png" height="27"/></a></li>
        ...
        <footer class="footer">
            <div class="container-fluid footer-content">
                <button class="btn-buttom btn-buttom-info"><a href="javascript:location.reload();" style="color: #585858;text-decoration: none">眠按钮 1.1.520</a></button><button class="btn-buttom btn-buttom-info" style="margin-left:5px;"><a href='https://www.vercel.com/?utm_source=vbuposc&utm_campaign=oss' style="color: #eeeeee;text-decoration: none"><img src="/resources/vercel.svg" style="height:13px;"></a></button>
                <div class="pull-left">
                    <div class="text-left" style="color: #ffffff;">{{$t("info.author")}}</div>
                    <div class="text-left">{{$t("info.notOfficial")}}</div>
                    <div class="text-left"><a href="https://voosc.github.io/mmzm-button/" target="_blank">{{$t("info.audioStaff")}}</a></div>
                    <div class="text-left"><a href="https://github.com/voosc/mmzm-button" target="_blank">{{$t("info.toGithub")}}</a></div>
                </div>
            </div>
        </footer>
  </div>
